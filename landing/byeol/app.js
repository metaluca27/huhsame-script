...
function spiritCharSVG(wuxingKey) {
  var chars = {
    ...
    earth: '<svg viewBox="0 0 100 108"><defs><radialGradient id="ge" cx="45%" cy="32%" r="78%"><stop offset="0" stop-color="#ffeeb8"/><stop offset="55%" stop-color="#f3c85f"/><stop offset="100%" stop-color="#d99f34"/></radialGradient></defs><path d="M22 66a28 26 0 0 1 56 0c0 8-4 14-10 14H32c-6 0-10-6-10-14Z" fill="url(#ge)"/><ellipse cx="50" cy="52" rx="30" ry="24" fill="url(#ge)"/><ellipse cx="40" cy="42" rx="8" ry="11" fill="#fff" opacity=".5" transform="rotate(-18 40 42)"/><g class="eyes" fill="#6e4d15"><ellipse cx="42" cy="56" rx="3.2" ry="4.2"/><ellipse cx="58" cy="56" rx="3.2" ry="4.2"/></g><circle cx="34" cy="64" r="4.5" fill="#ff8fa3" opacity=".5"/><circle cx="66" cy="64" r="4.5" fill="#ff8fa3" opacity=".5"/><path d="M44 64q6 5 12 0" stroke="#6e4d15" stroke-width="2.2" fill="none" stroke-linecap="round"/></svg>',
    metal: '<svg viewBox="0 0 100 108"><defs><linearGradient id="gm" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#ffffff"/><stop offset="55%" stop-color="#dbe4f2"/><stop offset="100%" stop-color="#a9b8d4"/></linearGradient></defs><rect x="24" y="34" width="52" height="52" rx="16" fill="url(#gm)" transform="rotate(6 50 60)"/><ellipse cx="40" cy="46" rx="7" ry="11" fill="#fff" opacity=".7" transform="rotate(-18 40 46)"/><g class="eyes" fill="#3e4d6b"><ellipse cx="42" cy="60" rx="3.2" ry="4.2"/><ellipse cx="58" cy="60" rx="3.2" ry="4.2"/></g><circle cx="34" cy="68" r="4.5" fill="#ff8fa3" opacity=".45"/><circle cx="66" cy="68" r="4.5" fill="#ff8fa3" opacity=".45"/><path d="M44 68q6 5 12 0" stroke="#3e4d6b" stroke-width="2.2" fill="none" stroke-linecap="round"/></svg>'
  };
