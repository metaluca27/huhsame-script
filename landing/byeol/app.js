...
function spiritCharSVG(wuxingKey) {
  var chars = {
    water: '<svg xmlns="http://www.w3.org/2000/svg" class="face-blink" viewBox="0 0 100 108"><defs><radialGradient id="gw" cx="45%" cy="30%" r="75%"><stop offset="0" stop-color="#bfeeff"/><stop offset="55%" stop-color="#5cc0f2"/><stop offset="100%" stop-color="#2b8fd6"/></radialGradient></defs><path d="M50 16C50 16 24 48 24 68a26 26 0 0 0 52 0C76 48 50 16 50 16Z" fill="url(#gw)"/><ellipse cx="40" cy="44" rx="8" ry="12" fill="#ffffff" opacity=".55" transform="rotate(-18 40 44)"/><g class="eyes" fill="#1d3347"><ellipse cx="42" cy="64" rx="3.2" ry="4.2"/><ellipse cx="58" cy="64" rx="3.2" ry="4.2"/></g><circle cx="34" cy="72" r="4.5" fill="#ff8fa3" opacity=".5"/><circle cx="66" cy="72" r="4.5" fill="#ff8fa3" opacity=".5"/><path d="M44 72q6 5 12 0" stroke="#1d3347" stroke-width="2.2" fill="none" stroke-linecap="round"/></svg>',
    fire: '<svg xmlns="http://www.w3.org/2000/svg" class="face-smile" viewBox="0 0 100 108"><defs><radialGradient id="gf" cx="45%" cy="35%" r="75%"><stop offset="0" stop-color="#ffe3b0"/><stop offset="50%" stop-color="#ff9a5c"/><stop offset="100%" stop-color="#f4623d"/></radialGradient></defs><path d="M54 14c3 14-10 18-13 32-2 10 4 22 13 22a22 22 0 0 0 22-24c0-9-8-13-10-21-4 8-7 0-12-13-1 6-1 4 0 0Z" fill="url(#gf)"/><path d="M54 16c2 12-9 16-11 28-2 9 3 18 11 18a18 18 0 0 0 18-20c0-8-6-11-8-17-3 7-7 1-10-9Z" fill="url(#gf)"/><ellipse cx="42" cy="42" rx="6" ry="10" fill="#fff" opacity=".5" transform="rotate(-15 42 42)"/><g class="eyes" fill="#7a2c18"><ellipse cx="44" cy="60" rx="3" ry="4"/><ellipse cx="58" cy="60" rx="3" ry="4"/></g><circle cx="37" cy="68" r="4.6" fill="#ff6f6f" opacity=".55"/><circle cx="65" cy="68" r="4.6" fill="#ff6f6f" opacity=".55"/><path d="M43 66q9 9 15 0" stroke="#7a2c18" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>',
    wood: '<svg xmlns="http://www.w3.org/2000/svg" class="face-tongue" viewBox="0 0 100 108"><defs><radialGradient id="gt" cx="45%" cy="32%" r="75%"><stop offset="0" stop-color="#d4ffcf"/><stop offset="55%" stop-color="#6fd97f"/><stop offset="100%" stop-color="#33ab52"/></radialGradient></defs><path d="M50 26q-11-16-2-22 9 7 2 22Z" fill="#4fc466"/><path d="M50 28q9-9 16-3-3 10-16 3Z" fill="#68d67c"/><circle cx="50" cy="60" r="27" fill="url(#gt)"/><ellipse cx="40" cy="46" rx="8" ry="11" fill="#fff" opacity=".5" transform="rotate(-18 40 46)"/><g class="eyes" fill="#1f5a2b"><ellipse cx="42" cy="60" rx="3.2" ry="4.2"/><ellipse cx="58" cy="60" rx="3.2" ry="4.2"/></g><circle cx="34" cy="68" r="4.5" fill="#ff8fa3" opacity=".5"/><circle cx="66" cy="68" r="4.5" fill="#ff8fa3" opacity=".5"/><path d="M44 68q6 5 12 0" stroke="#1f5a2b" stroke-width="2.2" fill="none" stroke-linecap="round"/><ellipse class="tongue" cx="50" cy="72.5" rx="4.5" ry="3.6" fill="#ff7a8a"/></svg>',
    earth: '<svg xmlns="http://www.w3.org/2000/svg" class="face-yawn" viewBox="0 0 100 108"><defs><radialGradient id="ge" cx="45%" cy="32%" r="78%"><stop offset="0" stop-color="#ffeeb8"/><stop offset="55%" stop-color="#f3c85f"/><stop offset="100%" stop-color="#d99f34"/></radialGradient></defs><path d="M22 66a28 26 0 0 1 56 0c0 8-4 14-10 14H32c-6 0-10-6-10-14Z" fill="url(#ge)"/><ellipse cx="50" cy="52" rx="30" ry="24" fill="url(#ge)"/><ellipse cx="40" cy="42" rx="8" ry="11" fill="#fff" opacity=".5" transform="rotate(-18 40 42)"/><g class="eyes" fill="#6e4d15"><ellipse cx="42" cy="56" rx="3.2" ry="4.2"/><ellipse cx="58" cy="56" rx="3.2" ry="4.2"/></g><circle cx="34" cy="64" r="4.5" fill="#ff8fa3" opacity=".5"/><circle cx="66" cy="64" r="4.5" fill="#ff8fa3" opacity=".5"/><ellipse class="mouth-yawn" cx="50" cy="65" rx="5" ry="4.5" fill="#5a3d10"/></svg>',
    metal: '<svg xmlns="http://www.w3.org/2000/svg" class="face-wink" viewBox="0 0 100 108"><defs><linearGradient id="gm" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#ffffff"/><stop offset="55%" stop-color="#dbe4f2"/><stop offset="100%" stop-color="#a9b8d4"/></linearGradient></defs><rect x="24" y="34" width="52" height="52" rx="16" fill="url(#gm)" transform="rotate(6 50 60)"/><ellipse cx="40" cy="46" rx="7" ry="11" fill="#fff" opacity=".7" transform="rotate(-18 40 46)"/><g class="eyes" fill="#3e4d6b"><ellipse cx="42" cy="60" rx="3.2" ry="4.2"/><ellipse class="wink-eye" cx="58" cy="60" rx="3.2" ry="4.2"/></g><circle cx="34" cy="68" r="4.5" fill="#ff8fa3" opacity=".45"/><circle cx="66" cy="68" r="4.5" fill="#ff8fa3" opacity=".45"/><path d="M44 68q6 5 12 0" stroke="#3e4d6b" stroke-width="2.2" fill="none" stroke-linecap="round"/></svg>'
  };
